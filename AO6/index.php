...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["postID"])) {
    ...
    if (!empty($postID)) {
        ...
        if (mysqli_query($conn, $deleteSQL)) {
            header("Location: " . $_SERVER['PHP_SELF']); // Refresh page to show updated posts
            exit;
        } else {
...
//GET THE POST THAT IS NOT DELETED
$sql = "
    SELECT p.postID, p.content, p.dateTime, p.attachment, u.username, ui.firstname, ui.lastname
    FROM posts p
